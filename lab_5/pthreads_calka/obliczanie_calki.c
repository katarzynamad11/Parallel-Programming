...
void dekompozycja_cykliczna(int my_id, int l_w, int N, int *my_start, int *my_end);
void dekompozycja_blokowa(int my_id, int l_w, int N, int *my_start, int *my_end);
...
void dekompozycja_blokowa(int my_id, int l_w, int N, int *my_start, int *my_end){
*my_start = (N * my_id) / l_w;
*my_end = (N*(my_id+1))/l_w;
}

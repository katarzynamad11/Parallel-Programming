...
MPI_Scatter(a, n_wier * WYMIAR, MPI_DOUBLE, a_local, n_wier * WYMIAR, MPI_DOUBLE, root_proc, MPI_COMM_WORLD);
    double* x_local = malloc(sizeof(double) * n_wier);
  MPI_Scatter(x, n_wier * WYMIAR, MPI_DOUBLE, a_local, n_wier * WYMIAR, MPI_DOUBLE, root_proc, MPI_COMM_WORLD);  
